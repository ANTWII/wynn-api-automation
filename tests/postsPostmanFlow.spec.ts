...
test.describe('JSONPlaceholder API Tests - API Flow', () => {
  ...
  test('GET /posts/1 - Get specific post', { tag: ["@api-flow"] }, async () => {
    logger.info('Starting test: GET /posts/1 - Get specific post');
    ...
    try {
      ...
      logger.error('Test failed: GET /posts/1 - Get specific post', error as Error);
      throw error;
    }
  });
  ...
  test('PUT /posts/1 - Full update post', { tag: ["@api-flow"] }, async () => {
    logger.info('Starting test: PUT /posts/1 - Full update post');
    ...
    try {
      ...
      logger.error('Test failed: PUT /posts/1 - Full update post', error as Error);
      throw error;
    }
  });

  test('PATCH /posts/1 - Partial update post', { tag: ["@api-flow"] }, async () => {
    logger.info('Starting test: PATCH /posts/1 - Partial update post');
    ...
    try {
      ...
      logger.error('Test failed: PATCH /posts/1 - Partial update post', error as Error);
      throw error;
    }
  });

  test('DELETE /posts/1 - Delete post', { tag: ["@api-flow"] }, async () => {
    logger.info('Starting test: DELETE /posts/1 - Delete post');
